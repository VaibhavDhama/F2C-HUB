...
mongoose.connect("mongodb://localhost:27017/f2c");
...
async function fetchAndProcessUsers(req,res){
    try{
        ...
        res.render('marketplace',{listTitle:"Vaibhav" , newListItems:users});
    }catch(err){
        console.log(err);
    }
}
...
async function fetchTracking(req,res){
    try{
        ...
        res.render('tracking',{listTitle:"Vaibhav" , newListItems:users});
    }catch(err){
        console.log(err);
    }
}
...
async function fetchFeedback(req,res){
    try{
        ...
        res.render('feedbackFetcher',{listTitle:"Vaibhav" , newListItems:users});
    }catch(err){
        console.log(err);
    }
}
